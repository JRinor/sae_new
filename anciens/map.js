...
const Map = ({ points }) => {
    ...
    const getInstructionIcon = (text) => {
        if (text.includes('Turn right') || text.includes('Sharp right')) {
            return <FaArrowRight color="blue" size={20} />;
        }
        if (text.includes('Turn left') || text.includes('Sharp left')) {
            return <FaArrowLeft color="blue" size={20} />;
        }
        if (text.includes('Continue straight') || text.includes('Go straight')) {
            return <FaArrowUp color="blue" size={20} />;
        }
        if (text.includes('Enter the traffic circle') || text.includes('At the roundabout')) {
            return <FaSyncAlt color="blue" size={20} />;
        }
